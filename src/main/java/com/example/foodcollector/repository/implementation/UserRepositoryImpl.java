...
import com.example.foodcollector.repository.DataSourceConfig;
import com.example.foodcollector.repository.UserRepository;
import com.example.foodcollector.repository.mappers.UserRowMapper;
...
public class UserRepositoryImpl implements UserRepository {
    ...
    public boolean isTaskOwner(Long userId, Long taskId) {
        try {
            ...
            throw new ResourceMappingException("Exception while confirming that user is the task owner.");
        }
    }
